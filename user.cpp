...
void register_vaccine()
{
	...
	if (found != nullptr)
	{
		cout << "\n\t\t\tCitizen with this citizen id already registered, CHECK YOUR ID  " << endl;
		return;
	}
	...
	User *new_citizen = new User(name, phone_no, id, gender, age, time_slot, comorbidities, pswd, vaccine); //  citizen node Creation
