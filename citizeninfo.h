/* A HEADER FIILE WHICH STORES THE DETAILS OF THE USERS AND HELP THE PROJECT IN SEARCHING AND ADDING OTHER USERS */
#ifndef CITIZEN_H_
#define CITIZEN_H_
#include <string>
using namespace std;
...
public:
                          /* Constructor	 */
	User(string nm , string pn ,int cit_id, char sx, int ag,int timeslot, bool comor, string pswd,string vacc) 
	{
		citizen_id = cit_id;
		name = nm;
		phone_no= pn;
